...
function Home() {
  return (
    <>
      <main>
        <Hero />
        <div className="bg-accent p-4 text-primary py-16 flex flex-col items-center">
          <h2 className="text-5xl font-bold text-center pb-12">
            Why Choose Us
          </h2>
          <ul className="steps steps-vertical w-[1100px]">
            <li className=" step step-secondary font-semibold text-xl pb-12">
            ...
            <li className="step step-secondary font-semibold text-xl">
